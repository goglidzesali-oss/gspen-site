...
var M = {
/* ===== shared chrome ===== */
"საქართველოს პარენტერალური, ენტერალური კვებისა და მეტაბოლიზმის საზოგადოება":"Georgian Society for Parenteral, Enteral Nutrition and Metabolism",
"GSPEN — საქართველოს პარენტერალური, ენტერალური კვებისა და მეტაბოლიზმის საზოგადოება":"GSPEN — Georgian Society for Parenteral, Enteral Nutrition and Metabolism",
"© 2026 GSPEN — საქართველოს პარენტერალური, ენტერალური კვებისა და მეტაბოლიზმის საზოგადოება":"© 2026 GSPEN — Georgian Society for Parenteral, Enteral Nutrition and Metabolism",
"საქართველოს პარენტერალური, ენტერალური კვებისა და მეტაბოლიზმის საზოგადოება — კლინიკური კვების ეროვნული წარმომადგენლობითი ორგანო საქართველოში.":"The Georgian Society for Parenteral, Enteral Nutrition and Metabolism — the national representative body for clinical nutrition in Georgia.",
"მთავარი":"Home",
...
"წესდება":"Charter",
"საზოგადოების მმართველი დოკუმენტი":"The society's governing document",
"პროექტები ▾":"Projects ▾",
"პროექტები":"Projects",
"მიმდინარე":"Current",
...
/* ===== home ===== */
"GSPEN · პროფესიული საზოგადოება":"GSPEN · Professional society",
...
"კლინიკური კვების ეროვნული საზოგადოება — მისია, პრინციპები და მმართველობითი ორგანო →":"The national clinical nutrition society — mission, principles and governing body →",
...
"არის პროფესიული საზოგადოება, რომელიც ზრდის ცნობიერებას მალნუტრიციის შესახებ და მუშაობს პაციენტთა ნუტრიციული ზრუნვის გასაუმჯობესებლად — როგორც საავადმყოფოებში, ისე ბინაზე მოვლის პირობებში.":"is a professional society that raises awareness of malnutrition and works to improve the nutritional care of patients — both in hospitals and in home-care settings.",
...
"საზოგადოების შექმნის მიზანი იყო ქართულ ჯანდაცვის პრაქტიკასა და საერთაშორისო კლინიკურ სტანდარტებს შორის არსებული ნაპრალის შევსება. დამფუძნებელმა გუნდმა გააცნობიერა საქართველოში არსებული „ორმაგი გამოწვევის\" მოგვარების გადაუდებელი საჭიროება: სიმსუქნის მეტაბოლური კრიზისისა და კლინიკური მალნუტრიციის დაფარული საფრთხის.":"The society was created to close the gap between Georgian healthcare practice and international clinical standards. The founding team recognised the urgent need to address Georgia's “double challenge”: the metabolic crisis of obesity and the hidden threat of clinical malnutrition.",
...
"საქართველოს პარენტერალური, ენტერალური კვებისა და მეტაბოლიზმის საზოგადოება დაფუძნებულია როგორც არასამეწარმეო (არაკომერციული) იურიდიული პირი. მიღებულია დამფუძნებელი კრების მიერ — 2025 წლის 9 დეკემბერი, თბილისი.":"The Georgian Society for Parenteral, Enteral Nutrition and Metabolism is established as a non-entrepreneurial (non-commercial) legal entity. Adopted by the Founding Assembly — 9 December 2025, Tbilisi.",
"ზოგადი დებულებები":"General provisions",
"1.1. სახელწოდება":"1.1. Name",
"საზოგადოების სახელწოდებაა „Georgian Society for Parenteral, Enteral Nutrition and Metabolism\", შემდგომში მოხსენიებული როგორც „GSPEN\" (ან საზოგადოება). ქართულ ენაზე იგი მოიხსენიება როგორც „საქართველოს პარენტერალური, ენტერალური კვებისა და მეტაბოლიზმის საზოგადოება\".":"The name of the society is “Georgian Society for Parenteral, Enteral Nutrition and Metabolism”, hereinafter referred to as “GSPEN” (or the Society). In Georgian it is referred to as “sakartvelos parenteraluri, enteraluri kvebisa da metabolizmis sazogadoeba”.",
...
"GSPEN-ის (საქართველოს პარენტერალური, ენტერალური კვებისა და მეტაბოლიზმის საზოგადოება) ორგანიზებით გაიმართება ონლაინ ვებინარი, რომელიც ეძღვნება კვების მართვას ტიპი I დიაბეტის დროს.":"Organized by GSPEN (the Georgian Society for Parenteral, Enteral Nutrition and Metabolism), an online webinar will be held on nutrition management in type 1 diabetes.",
"GSPEN-ის (საქართველოს პარენტერალური, ენტერალური კვებისა და მეტაბოლიზმის საზოგადოება) ორგანიზებით გაიმართება ონლაინ ვებინარი, რომელიც ეძღვნება კვებას ბარიატრიული ქირურგიის გარშემო.":"Organized by GSPEN (the Georgian Society for Parenteral, Enteral Nutrition and Metabolism), an online webinar will be held on nutrition around bariatric surgery.",
"GSPEN-ის (საქართველოს პარენტერალური, ენტერალური კვებისა და მეტაბოლიზმის საზოგადოება) ორგანიზებით გაიმართება ონლაინ ვებინარი, რომელიც ეძღვნება ცელიაკიის დროს კვების მართვას.":"Organized by GSPEN (the Georgian Society for Parenteral, Enteral Nutrition and Metabolism), an online webinar will be held on nutrition management in celiac disease.",
...
"GSPEN-ის (საქართველოს პარენტერალური, ენტერალური კვებისა და მეტაბოლიზმის საზოგადოება) ორგანიზებით გაიმართება ვებინარი, რომელიც ეძღვნება ნაწლავის ანთებითი დაავადებების (IBD) დროს კვების მართვას ზრდასრულ პაციენტებში.":"GSPEN (the Georgian Society for Parenteral, Enteral Nutrition and Metabolism) is hosting a webinar dedicated to the nutritional management of inflammatory bowel disease (IBD) in adult patients.",
...
"მიმღები":"Beneficiary",
"ა(ა)იპ საქართველოს პარენტერალური, ენტერალური კვებისა და მეტაბოლიზმის საზოგადოება":"NNLE Georgian Society for Parenteral, Enteral Nutrition and Metabolism",
"ბანკი":"Bank",
...
"⚠ რეკვიზიტები შეივსება საზოგადოების საბანკო ანგარიშის გახსნის შემდეგ.":"⚠ Details will be added once the society's bank account is opened.",
...
"GSPEN-ის (საქართველოს პარენტერალური, ენტერალური კვებისა და მეტაბოლიზმის საზოგადოება) ორგანიზებით გაიმართა ვებინარი, რომელიც ეძღვნება ნაწლავის ანთებითი დაავადებების (IBD) დროს კვების მართვას ზრდასრულ პაციენტებში.":"GSPEN (the Georgian Society for Parenteral, Enteral Nutrition and Metabolism) hosted a webinar dedicated to the nutritional management of inflammatory bowel disease (IBD) in adult patients.",
...
"გასახსნელად მხოლოდ მოკლე ინფორმაცია გვჭირდება — ეს საზოგადოებას ეხმარება, უკეთ დაგეგმოს მომავალი ვებინარები.":"We just need a little information to unlock it — this helps the society plan future webinars better.",
...
,
/* ===== intro webinar + Nino grant ===== */
"რას აკეთებს GSPEN — საგანმანათლებლო აქტივობები, კურსები და ჰოსპიტალური მალნუტრიციის კვლევა (nutritionDay საქართველოში);":"what GSPEN does — educational activities, courses and the study of hospital malnutrition (nutritionDay in Georgia);",
"ESPEN-თან ურთიერთობა და შესაძლებლობები — სამეცნიერო და სასწავლო გრანტები, LLL კურსები, კონგრესები და საერთაშორისო კვლევებში მონაწილეობა;":"the relationship with ESPEN and its opportunities — research and educational grants, LLL courses, congresses and participation in international studies;",
"როგორ ჩაერთოთ — GSPEN-ის წევრობა და რას სთავაზობს ის თითოეულ წევრს.":"how to get involved — GSPEN membership and what it offers each member.",
"დაგეგმილი ვებინარი · 30 სექტემბერი, 20:00":"Upcoming webinar · 30 September, 20:00",
"გაცნობითი შეხვედრა — ვინ ვართ ჩვენ და რა არის ESPEN":"Introductory meeting — who we are and what ESPEN is",
"ონლაინ Zoom-ში, მონაწილეობა უფასოა — რეგისტრაცია ღიაა":"Online on Zoom, free of charge — registration is open",
"დარეგისტრირდი →":"Register →",
"სიახლე · ESPEN-ის გრანტი":"News · ESPEN grant",
"ჩვენი გუნდის წევრმა ნინი ზივზივაძემ ESPEN-ის გრანტი მიიღო":"Our team member Nini Zivzivadze has received an ESPEN grant",
"14-დღიანი პროფესიული კურსი KU Leuven-ის უნივერსიტეტში, ბელგია":"A 14-day professional course at KU Leuven University, Belgium",
"30 სექტემბერი · 20:00":"30 September · 20:00",
"ონლაინ Zoom-ში, მონაწილეობა უფასოა — დარეგისტრირდი და შეხვედრის ბმულს ელფოსტაზე მიიღებ →":"Online on Zoom, free of charge — register and you will receive the meeting link by e-mail →",
"18 სექტემბერი, 2026":"18 September, 2026",
"14-დღიანი პროფესიული კურსი KU Leuven-ის უნივერსიტეტში, ბელგია — ESPEN-ის 2026 წლის საგანმანათლებლო გრანტით →":"A 14-day professional course at KU Leuven University, Belgium — with the 2026 ESPEN Educational Grant →",
"ონლაინ გაცნობითი შეხვედრა Zoom-ში — GSPEN-ის საქმიანობა და ESPEN-ის წევრობის შესაძლებლობები. მონაწილეობა უფასოა.":"An online introductory meeting on Zoom — GSPEN's work and the opportunities that ESPEN membership offers. Participation is free.",
"GSPEN-ის გუნდი":"The GSPEN team",
"GSPEN-ის გუნდი წარმოგიდგენთ საზოგადოების საქმიანობას და იმ საერთაშორისო შესაძლებლობებს, რომლებსაც ESPEN-ის წევრობა ქართველ ექიმებს, დიეტოლოგებსა და სტუდენტებს უხსნის.":"The GSPEN team will present the society's work and the international opportunities that ESPEN membership opens up for Georgian physicians, dietitians and students.",
"ვისაუბრებთ:":"We will talk about:",
"• რას აკეთებს GSPEN — საგანმანათლებლო აქტივობები, კურსები და ჰოსპიტალური მალნუტრიციის კვლევა (nutritionDay საქართველოში);":"• what GSPEN does — educational activities, courses and the study of hospital malnutrition (nutritionDay in Georgia);",
"• ESPEN-თან ურთიერთობა და შესაძლებლობები — სამეცნიერო და სასწავლო გრანტები, LLL კურსები, კონგრესები და საერთაშორისო კვლევებში მონაწილეობა;":"• the relationship with ESPEN and its opportunities — research and educational grants, LLL courses, congresses and participation in international studies;",
"• როგორ ჩაერთოთ — GSPEN-ის წევრობა და რას სთავაზობს ის თითოეულ წევრს.":"• how to get involved — GSPEN membership and what it offers each member.",
"ვებინარი განკუთვნილია ექიმებისთვის, დიეტოლოგებისთვის, ექთნებისთვის, ფარმაცევტებისა და სამედიცინო სტუდენტებისთვის — ყველასთვის, ვისაც კლინიკური კვება აინტერესებს.":"The webinar is intended for physicians, dietitians, nurses, pharmacists and medical students — for everyone interested in clinical nutrition.",
"რეგისტრაციის შემდეგ Zoom-ის ბმულს ელფოსტაზე მიიღებთ. ჩანაწერი ვებინარების გვერდზე დაიდება.":"After registering you will receive the Zoom link by e-mail. The recording will be published on the webinars page.",
"ნინი წავა ბელგიაში, KU Leuven-ის უნივერსიტეტში, 14-დღიან პროფესიულ კურსზე — ESPEN-ის 2026 წლის საგანმანათლებლო გრანტით.":"Nini is going to Belgium, to KU Leuven University, for a 14-day professional course — with the 2026 ESPEN Educational Grant.",
"ჩვენი გუნდის წევრმა ნინი ზივზივაძემ ESPEN-ის (ევროპის კლინიკური ნუტრიციოლოგიისა და მეტაბოლიზმის საზოგადოება) 2026 წლის საგანმანათლებლო გრანტი მიიღო.":"Our team member Nini Zivzivadze has received the 2026 Educational Grant of ESPEN (the European Society for Clinical Nutrition and Metabolism).",
"ნინი წავა ბელგიაში, KU Leuven-ის უნივერსიტეტში, Prof. Christophe Matthys-ის ხელმძღვანელობით, 14-დღიან პროფესიულ კურსზე. კურსის ფარგლებში ის პრაქტიკულ გამოცდილებას მიიღებს კლინიკური კვების, მეტაბოლიზმის, ენდოკრინოლოგიისა და სიმსუქნის მართვის მიმართულებით — მათ შორის პედიატრიულ პაციენტებთან მუშაობაში.":"Nini is going to Belgium, to KU Leuven University, for a 14-day professional course under the supervision of Prof. Christophe Matthys. During the course she will gain practical experience in clinical nutrition, metabolism, endocrinology and obesity management — including work with paediatric patients.",
"როგორ მოვიპოვოთ ESPEN-ის გრანტი":"How to obtain an ESPEN grant",
"ESPEN-ის კვლევით, სასწავლო და სამოგზაურო გრანტებზე განაცხადის შეტანა მხოლოდ ESPEN-ის წევრს შეუძლია. GSPEN კი უკვე":"Only an ESPEN member can apply for ESPEN research, educational and travel grants. GSPEN, however, is already",
"ESPEN-ის ბლოკწევრია":"a block member of ESPEN",
"— ჩვენი წევრები ESPEN-ის სრულუფლებიან წევრობას შეღავათიანი ტარიფით იღებენ და, შესაბამისად, გრანტებზე წვდომაც უჩნდებათ.":"— our members obtain full ESPEN membership at a reduced rate and therefore gain access to the grants.",
"გსურთ, მეტი გაიგოთ?":"Would you like to know more?",
"დარეგისტრირდით GSPEN-ის გაცნობით შეხვედრაზე —":"Register for the GSPEN introductory meeting —",
"30 სექტემბერს, 20:00 საათზე, Zoom-ში":"on 30 September at 20:00, on Zoom",
", სადაც ESPEN-ის გრანტებსა და წევრობის სხვა შესაძლებლობებზეც ვისაუბრებთ.":", where we will also talk about ESPEN grants and other membership opportunities.",
/* ===== IBD webinar Q&A answers ===== */
"ილეოსტომის დროს ბოჭკოს მიღება გამონადენს ოდნავ ზრდის, მაგრამ, როგორც წესი, ნორმის ფარგლებში რჩება — ამიტომ ბოჭკო მთლიანად არ უნდა ამოიღოთ. მთავარი რისკი გამონადენის მკვეთრი მომატება და გაუწყლოებაა: ასეთ დროს შეზღუდეთ ჰიპოტონური სითხეები (წყალი, ჩაი, წვენები — დღეში 1 ლიტრამდე), მიიღეთ მარილიანი საკვები და გლუკოზა-მარილიანი ხსნარები. თუ წვრილი ნაწლავის ტერმინალური ნაწილი ამოკვეთილია (>20 სმ), საჭიროა B12 ვიტამინის კონტროლი და, ხშირად, პროფილაქტიკური მიღება; სტრიქტურის არსებობისას კი — ბოჭკოთი ღარიბი დიეტა.":"With an ileostomy, fibre intake slightly increases the output, but it usually stays within the normal range — so fibre should not be removed completely. The main risk is a sharp rise in output and dehydration: in that case restrict hypotonic fluids (water, tea, juices — up to 1 litre per day) and take salty foods and glucose–salt solutions. If the terminal small bowel has been resected (>20 cm), vitamin B12 monitoring — and often prophylactic supplementation — is needed; in the presence of a stricture, a low-fibre diet.",
"წყარო: ECCO Consensus on Dietary Management of IBD 2025 (Statements 21.1, 24, 32); ESPEN Practical Guideline IBD 2020 (Rec. 9B); BIFA Top Tips — High Output Stoma.":"Sources: ECCO Consensus on Dietary Management of IBD 2025 (Statements 21.1, 24, 32); ESPEN Practical Guideline IBD 2020 (Rec. 9B); BIFA Top Tips — High Output Stoma.",
"წყლულოვანი კოლიტის დროს რემისიის შესანარჩუნებლად შერჩეული პრობიოტიკები (მაგ. E. coli Nissle 1917, მრავალშტამიანი ნარევი — ყოფილი VSL#3, საქართველოში არ მოიპოვება) შესაძლოა ეფექტური იყოს. კრონის დაავადების დროს კი პრობიოტიკები რემისიის შენარჩუნებაში არაეფექტურია და არ არის რეკომენდებული. სიმბიოტიკებზე ამ ეტაპისთვის მონაცემები არ არსებობს.":"In ulcerative colitis, selected probiotics (e.g. E. coli Nissle 1917, or the multi-strain mixture formerly known as VSL#3, not available in Georgia) may be effective for maintaining remission. In Crohn's disease, probiotics are ineffective for maintaining remission and are not recommended. For synbiotics, no data are available at this stage.",
"წყარო: ESPEN Practical Guideline IBD 2020 (Rec. 31, 32A, 33B); ESPEN Guideline IBD 2023 (Rec. 53).":"Sources: ESPEN Practical Guideline IBD 2020 (Rec. 31, 32A, 33B); ESPEN Guideline IBD 2023 (Rec. 53).",
"გლუტენისა და ლაქტოზის რაციონიდან ამოღება მხოლოდ და მხოლოდ კლინიკურად დადასტურებული აუტანლობის დროსაა რეკომენდებული, ანუ მას შემდეგ, რაც რამდენიმეკვირიანი შეზღუდული დიეტის ფონზე ვხედავთ სიმპტომების გაუმჯობესებას და ხელახალი ჩართვისას — სიმპტომების დაბრუნებას. ლაქტოზისა და გლუტენის ამოღება დაავადების მკურნალობის ან სიმპტომების პრევენციის მიზნით მართებული არ არის.":"Removing gluten and lactose from the diet is recommended only in clinically confirmed intolerance — that is, once symptoms improve over several weeks of an exclusion diet and return on reintroduction. Removing lactose and gluten in order to treat the disease or prevent symptoms is not appropriate.",
"წყარო: ECCO Consensus 2025 (Statement 15.3); ESPEN Guideline on Hospital Nutrition 2021 (Rec. 28, gluten commentary); ESPEN Guideline IBD 2023 (malabsorption commentary); UpToDate 2026 — Nutrition in adults with IBD.":"Sources: ECCO Consensus 2025 (Statement 15.3); ESPEN Guideline on Hospital Nutrition 2021 (Rec. 28, gluten commentary); ESPEN Guideline IBD 2023 (malabsorption commentary); UpToDate 2026 — Nutrition in adults with IBD.",
"დივერტიკულიტი მსხვილი ნაწლავის კედელში წარმოქმნილი ჯიბეების (დივერტიკულების) ანთებაა, რომელიც მოულოდნელ გამწვავებას იწვევს — მუცლის ტკივილს, ცხელებას, განავლის ცვლილებას.":"Diverticulitis is inflammation of the pouches (diverticula) formed in the wall of the colon, causing sudden flare-ups — abdominal pain, fever and a change in bowel habit.",
"გამწვავების დროს, თუ საავადმყოფოში მკურნალობა დაგჭირდათ, სითხეს ჯერ ვენიდან მიიღებთ, შემდეგ კი გადახვალთ გამჭვირვალე სითხეებზე, რადგან ისინი ადვილად მოსანელებელია; საჭიროების შემთხვევაში ემატება თხევადი კვებითი დანამატი. მსუბუქი ეპიზოდის დროს სახლში ექიმმა შესაძლოა რამდენიმე დღით მხოლოდ გამჭვირვალე სითხეები და საკვები გირჩიოთ: ქათმის, ხორცის ან ბოსტნეულის ბულიონი; ხილის წვენი რბილობის გარეშე (ვაშლის, მოცვის, ყურძნის); წყალი; ჩაი ან ყავა ნაღების გარეშე; ხილის ნაჭრების გარეშე დამზადებული ხილის ნაყინი; კარამელი. ამის შემდეგ ჩვეულ რაციონს თანდათან უბრუნდებით.":"During a flare-up, if you need hospital treatment, fluids are first given intravenously, and you then move on to clear liquids, as they are easy to digest; a liquid nutritional supplement is added if needed. In a mild episode treated at home, your doctor may advise only clear liquids and foods for a few days: chicken, meat or vegetable broth; pulp-free fruit juice (apple, cranberry, grape); water; tea or coffee without cream; fruit ice pops made without fruit pieces; hard candy. After that, you gradually return to your usual diet.",
"გამჭვირვალე სითხეების დიეტა ხანგრძლივად არ გამოიყენება — ის ორგანიზმს ბოჭკოსა და სხვა საკვებ ნივთიერებებს საკმარისად ვერ აწვდის.":"A clear-liquid diet is not used for long — it cannot supply the body with enough fibre and other nutrients.",
"წყარო: Diverticular disease. National Institute of Diabetes and Digestive and Kidney Diseases (NIDDK). https://www.niddk.nih.gov/health-information/digestive-diseases/diverticulosis-diverticulitis/all-content":"Source: Diverticular disease. National Institute of Diabetes and Digestive and Kidney Diseases (NIDDK). https://www.niddk.nih.gov/health-information/digestive-diseases/diverticulosis-diverticulitis/all-content",
"მტკიცებულებით ყველაზე ძლიერია არა კონკრეტული პროდუქტების აკრძალვა, არამედ: წონის კლება (10%-ით კლება სიმპტომებსაც და PPI-ის მოხმარებასაც ამცირებს), საწოლის თავის აწევა, მოწევის შეწყვეტა, ვახშამი ძილამდე მინიმუმ 3 საათით ადრე და ხშირი, მცირე, ნაკლებკალორიული ულუფების მიღება. „კლასიკური“ ტრიგერები (ყავა, შოკოლადი, პიტნა, ალკოჰოლი, ცხარე და მჟავე საკვები, გაზიანი სასმელი) მხოლოდ იმ პაციენტს უნდა შეეზღუდოს, ვისთანაც ისინი რეალურად იწვევს სიმპტომებს.":"The strongest evidence supports not the banning of specific foods but: weight loss (a 10% reduction lowers both symptoms and PPI use), raising the head of the bed, stopping smoking, having dinner at least 3 hours before bedtime, and eating frequent, small, lower-calorie meals. The “classic” triggers (coffee, chocolate, mint, alcohol, spicy and acidic foods, carbonated drinks) should be restricted only in patients in whom they actually provoke symptoms.",
"წყარო: Present Knowledge in Nutrition, 11th ed. 2020 (GERD); Nutrition, Weight, and Digestive Health — Clinician's Desk Reference 2022 (GERD — Eating Patterns); ESPEN/UEG Guideline on Obesity in GI Diseases 2022 (GERD commentary).":"Sources: Present Knowledge in Nutrition, 11th ed. 2020 (GERD); Nutrition, Weight, and Digestive Health — Clinician's Desk Reference 2022 (GERD — Eating Patterns); ESPEN/UEG Guideline on Obesity in GI Diseases 2022 (GERD commentary).",
/* ===== GLINTS article ===== */
...
"ინიციატივა 2025 წლის 14 სექტემბერს, პრაღაში, ESPEN-ის კონგრესზე დაიწყო და მასში მსოფლიოს ყველა წამყვანი კლინიკური კვების საზოგადოება მონაწილეობდა: ESPEN (ევროპა), ASPEN (ამერიკა), AuSPEN (ავსტრალაზია), FELANPE (ლათინური ამერიკა), PENSA (აზია) და SASPEN (სამხრეთ აფრიკა). 32 ექსპერტმა მოდიფიცირებული დელფის სამი რაუნდის შედეგად რვა დებულება შეაჯერა — თითოეულმა 85%-ზე მაღალ თანხმობას მიაღწია.":"The initiative was launched on 14 September 2025 in Prague, at the ESPEN Congress, with every leading clinical nutrition society in the world taking part: ESPEN (Europe), ASPEN (America), AuSPEN (Australasia), FELANPE (Latin America), PENSA (Asia) and SASPEN (South Africa). Through three rounds of a modified Delphi process, 32 experts agreed on eight statements — each reaching more than 85% agreement.",
"რატომ იყო ეს საჭირო":"Why this was needed",
"ჰოსპიტალიზებულ პაციენტებში მალნუტრიციის გავრცელება 35–50%-ს აღწევს და ყველაზე მაღალია ონკოლოგიურ და კრიტიკულ პაციენტებში. nutritionDay-ს გლობალური აუდიტის მონაცემებით (224 221 პაციენტი, 2006–2025), პაციენტების 44% კლინიკაში ყოფნის პერიოდში წონის კლებას აღნიშნავს, 51% კი შეფასების დღეს სრულ ულუფას ვერ ჭამს. შედეგები პირდაპირ აისახება გამოსავალზე: წონის კლება 30-დღიანი სიკვდილობის რისკს 1.69-ჯერ ზრდის, ულუფის მეოთხედზე ნაკლების მიღება — 1.4–3-ჯერ, დაბალი BMI — 1.5-ჯერ.":"The prevalence of malnutrition among hospitalised patients reaches 35–50% and is highest in oncology and critically ill patients. According to the global nutritionDay audit (224,221 patients, 2006–2025), 44% of patients report weight loss during their hospital stay, and 51% cannot finish a full meal on the day of assessment. The consequences directly affect outcomes: weight loss increases the 30-day mortality risk 1.69-fold, eating less than a quarter of a meal — 1.4–3-fold, and a low BMI — 1.5-fold.",
"ამის მიუხედავად, კვებითი ჩარევა კლინიკებში ხშირად გვიან იწყება ან საერთოდ არ იწყება — ერთ-ერთი მიზეზი კი სწორედ ის იყო, რომ არ არსებობდა მკაფიო, საერთაშორისოდ შეჯერებული კრიტერიუმები. მნიშვნელოვანი კონტექსტია ისიც, რომ 2025 წელს ჯანმო-მ ICD-11-ში ზრდასრულთა არასრულფასოვანი კვების ცალკე დიაგნოსტიკური კოდი (5B72) დაამტკიცა, რომელიც":"Despite this, nutritional intervention in hospitals often starts late or not at all — and one of the reasons was precisely the absence of clear, internationally agreed criteria. Another important part of the context is that in 2025 the WHO approved a dedicated ICD-11 diagnostic code for adult undernutrition (5B72), which is based on the",
"-ის კრიტერიუმებს ეყრდნობა და 2027 წლიდან ამოქმედდება.":" criteria and will come into force from 2027.",
"ოთხი ძირითადი ჩვენება":"Four main indications",
"GLINTS-ის მიხედვით, ნუტრიციული თერაპია/მხარდაჭერა ნაჩვენებია ოთხ შემთხვევაში:":"According to GLINTS, nutritional therapy/support is indicated in four situations:",
"დადასტურებული მალნუტრიცია":"Confirmed malnutrition",
"-ის ან სხვა ვალიდური კრიტერიუმებით (SGA, PG-SGA, MNA) დასმული დიაგნოზი":"-based diagnosis, or one established by other validated criteria (SGA, PG-SGA, MNA)",
"(თანხმობა 96%)":"(agreement 96%)",
"მალნუტრიციის მაღალი რისკი":"High risk of malnutrition",
"— თუ პოპულაციის რისკი უცნობია, გამოიყენება სკრინინგის ინსტრუმენტები; აშკარად მაღალი რისკის ჯგუფებში კი GLIM-ის კრიტერიუმები პირდაპირ, წინასწარი სკრინინგის გარეშეც შეიძლება იქნას გამოყენებული":"— when the risk in a population is unknown, screening tools are used; in clearly high-risk groups the GLIM criteria may be applied directly, even without prior screening",
"შემცირებული კვება":"Reduced food intake",
"— ბოლო ერთ კვირაში ჩვეული რაციონის ნახევარი ან ნაკლები, ან ნებისმიერი ხარისხის შემცირება ორ კვირაზე მეტხანს — დაავადების, ანთებითი პასუხის ან მძიმე გასტროინტესტინური სიმპტომების (დისფაგია, გულისრევა, ღებინება, დიარეა) ფონზე":"— half or less of the usual diet in the last week, or any reduction lasting more than two weeks — in the context of disease, an inflammatory response or severe gastrointestinal symptoms (dysphagia, nausea, vomiting, diarrhoea)",
"ხუთ დღეზე მეტხანს ჭამის შეუძლებლობა":"Inability to eat for more than five days",
"— მაშინაც კი, თუ პაციენტი მანამდე კარგად იკვებებოდა: უკვე 3–5 დღეში იწყება კუნთოვანი მასის კლინიკურად მნიშვნელოვანი კარგვა":"— even if the patient was previously well nourished: clinically meaningful loss of muscle mass begins within 3–5 days",
"როდის გადავიდეთ ზონდით ან პარენტერალურ კვებაზე":"When to move to tube or parenteral feeding",
"ენტერალური ზონდით კვება":"Enteral tube feeding",
"ნაჩვენებია, როცა პერორალური მიღება სავარაუდო ენერგიისა და ნუტრიენტების საჭიროების 50%-ზე ნაკლებს ფარავს და მნიშვნელოვანი გაუმჯობესება მოსალოდნელი არ არის. პერორალური კვება ამ დროსაც მაქსიმალურად უნდა შენარჩუნდეს, სანამ ეს უსაფრთხოა":"is indicated when oral intake covers less than 50% of estimated energy and nutrient requirements and no significant improvement is expected. Even then, oral intake should be maintained as much as possible, as long as it remains safe",
"პარენტერალური კვება":"Parenteral nutrition",
"ნაჩვენებია ნაწლავური უკმარისობის დროს — როცა ნაწლავის ფუნქცია იმ მინიმუმზე დაბალია, რომელიც მაკრონუტრიენტების, წყლისა და ელექტროლიტების ასათვისებლადაა საჭირო":"is indicated in intestinal failure — when gut function falls below the minimum needed to absorb macronutrients, water and electrolytes",
"დამატებითი პარენტერალური კვება":"Supplemental parenteral nutrition",
"განიხილება, როცა პერორალური და ენტერალური კვება, ოპტიმიზაციის მიუხედავად, ენერგიისა და ცილის საკმარის მიწოდებას ვერ უზრუნველყოფს; დაწყების დრო ინდივიდუალურია და პაციენტის ნუტრიციულ სტატუსზე, რისკსა და დაავადების სიმძიმეზეა დამოკიდებული":"is considered when oral and enteral nutrition, despite appropriate optimisation, cannot provide adequate energy and protein; the timing is individualised and depends on the patient's nutritional status, risk and disease severity",
". მნიშვნელოვანია: ეს არ ნიშნავს რუტინულ ადრეულ დამატებით პარენტერალურ კვებას მწვავე ავადმყოფობის პირველივე დღეებში.":". Importantly, this does not mean routine early supplemental parenteral nutrition in the very first days of acute illness.",
"რას ნიშნავს ეს პრაქტიკაში":"What this means in practice",
"პირველად გვაქვს გლობალურად შეჯერებული პასუხი კითხვაზე „როდის დავიწყოთ“. ეს კრიტერიუმები მარტივად დასამახსოვრებელია, ყოველდღიურ კლინიკურ მუშაობაში პირდაპირ გამოსაყენებელი და ნებისმიერი პროფილის განყოფილებას ეხება — თერაპიიდან ქირურგიამდე.":"For the first time we have a globally agreed answer to the question of when to start. These criteria are easy to remember, directly applicable in everyday clinical work, and relevant to units of any profile — from internal medicine to surgery.",
"GSPEN-ისთვის ეს დოკუმენტი განსაკუთრებით მნიშვნელოვანია: სწორედ ასეთ საერთაშორისო კონსენსუსებს დავეყრდნობით, როცა ეროვნულ პროტოკოლებზე ვიმუშავებთ — ეს კი":"For GSPEN this document is especially important: it is precisely such international consensus documents that we will rely on when working on national protocols — and this is",
"ჩვენი ESPEN-თან თანამშრომლობის":"one of the main goals of our collaboration with ESPEN",
"ერთ-ერთი მთავარი მიზანია.":".",
"მომზადებულია სალომე გოგლიძის მიერ":"Prepared by Salome Goglidze",
/* ===== ESPEN news v2 (full post) ===== */
"მოხარული ვართ გაცნობოთ, რომ ოფიციალურად გაფორმდა ბლოკწევრობის შეთანხმება საქართველოს პარენტერალური, ენტერალური კვებისა და მეტაბოლიზმის საზოგადოებასა (GSPEN) და ევროპის კლინიკური ნუტრიციოლოგიისა და მეტაბოლიზმის საზოგადოებას (ESPEN) შორის.":"We are delighted to announce that a Block Membership agreement has been officially signed between the Georgian Society for Parenteral, Enteral Nutrition and Metabolism (GSPEN) and the European Society for Clinical Nutrition and Metabolism (ESPEN).",
"რას ნიშნავს ეს?":"What does this mean?",
"GSPEN-ის ESPEN-ში გაწევრიანება ქართული სამედიცინო საზოგადოებისთვის უმნიშვნელოვანესი და ისტორიული ნაბიჯია, რადგან დღეს საქართველოში კლინიკური ნუტრიციოლოგია, როგორც დამოუკიდებელი სამედიცინო სფერო, პრაქტიკულად არ არსებობს. წლების განმავლობაში ეს სასიცოცხლოდ მნიშვნელოვანი მიმართულება ქვეყანაში სრულიად აუთვისებელი რჩებოდა და მხოლოდ ახლა დგამს პირველ ნაბიჯებს.":"GSPEN joining ESPEN is a landmark, historic step for the Georgian medical community, because today clinical nutrition as an independent medical field practically does not exist in Georgia. For years this vitally important discipline remained entirely undeveloped in the country, and it is only now taking its first steps.",
"სწორედ ამიტომ ESPEN-ის წევრობა გვაძლევს უნიკალურ შანსს, რომ შევავსოთ არსებული სიცარიელე, მრავალწლიანი ევროპული საერთაშორისო გამოცდილება გადმოვიტანოთ ქართულ კლინიკურ რეალობაში და საქართველოში ამ სფეროს განვითარებას მყარი საფუძველი ჩავუყაროთ.":"That is exactly why ESPEN membership gives us a unique chance to fill the existing gap, bring years of European and international experience into Georgian clinical practice, and lay a solid foundation for the development of this field in Georgia.",
"რას ნიშნავს ESPEN-ის ბლოკწევრობა?":"What is ESPEN block membership?",
"ბლოკწევრობა ESPEN-ის სპეციალური სტატუსია იმ ეროვნული ასოციაციებისთვის, რომლებთანაც ევროპულ საზოგადოებას პირდაპირი შეთანხმება აქვს გაფორმებული. ამ სტატუსის წყალობით, GSPEN-ის თითოეულ წევრს შეუძლია, გახდეს ESPEN-ის სრულუფლებიანი წევრი შეღავათიანი ტარიფით.":"Block membership is a special ESPEN status for national societies that have a direct agreement with the European society. Thanks to this status, every GSPEN member can become a full ESPEN member at a special rate.",
"რეგისტრაციისთვის იხილეთ":"For registration, see",
"შესაბამისი ბმული":"this link",
"რას იღებს GSPEN-ისა და ESPEN-ის წევრი?":"What does a GSPEN and ESPEN member receive?",
"საგანმანათლებლო პლატფორმებზე წვდომა:":"Access to educational platforms:",
"შემცირებული ტარიფი LLL (Life Long Learning) სერტიფიცირებულ კურსებზე და შეუზღუდავი წვდომა სასწავლო პლატფორმაზე":"reduced rates for LLL (Life Long Learning) certified courses and unlimited access to the learning platform",
"— რაც ESPEN-ის დიპლომის მოპოვების წინაპირობაა.":"— a prerequisite for obtaining the ESPEN Diploma.",
"უახლესი სამეცნიერო ლიტერატურა:":"The latest scientific literature:",
"უფასო ონლაინ წვდომა ევროპის წამყვან ჟურნალებზე — Clinical Nutrition და Clinical Nutrition ESPEN.":"free online access to Europe's leading journals — Clinical Nutrition and Clinical Nutrition ESPEN.",
"საერთაშორისო კონგრესები:":"International congresses:",
"შეღავათიანი რეგისტრაცია და მნიშვნელოვანი ფასდაკლება ESPEN-ის ყოველწლიურ კონგრესებზე დასასწრებად.":"discounted registration and significant savings on attending the annual ESPEN congresses.",
"გრანტები და კვლევები:":"Grants and research:",
"ESPEN-ის კვლევით, სასწავლო და სამოგზაურო გრანტებზე განაცხადის შეტანის უფლება.":"eligibility to apply for ESPEN research, educational and travel grants.",
"ექსკლუზიური მასალები:":"Exclusive materials:",
"წვდომა ESPEN-ის ვებინარებზე, გასული კონგრესების ჩანაწერებსა და საზოგადოების სიახლეების ცნობის ფურცელზე.":"access to ESPEN webinars, recordings of past congresses and the society's newsletter.",
"nutritionDay-ს საერთაშორისო პროექტში ჩართულობა:":"Participation in the international nutritionDay project:",
"შესაძლებლობა, მონაწილეობა მიიღოთ კლინიკური კვების უდიდეს გლობალურ აუდიტში, გამოიყენოთ ქართულ ენაზე უკვე ადაპტირებული კითხვარები და დააკავშიროთ თქვენი კლინიკის მონაცემები ერთიან საერთაშორისო ბაზასთან პაციენტთა გამოსავლების გასაუმჯობესებლად. მეტი ინფორმაციისთვის":"the opportunity to take part in the largest global audit of clinical nutrition, use questionnaires already adapted into Georgian, and link your clinic's data to a single international database to improve patient outcomes. For more information,",
"იხილეთ ბმული":"see this link",
"პუბლიკაციების მხარდაჭერა:":"Publication support:",
"ფასდაკლება სამეცნიერო სტატიის გამოქვეყნებაზე ღია წვდომის ჟურნალში Clinical Nutrition Open Science.":"a discount on publishing a scientific article in the open-access journal Clinical Nutrition Open Science.",
"რას შეცვლის ეს ადგილობრივ დონეზე?":"What will this change locally?",
"ჩვენი მთავარი მიზანი ევროპული გამოცდილების ქართულ რეალობად ქცევა და კლინიკური ნუტრიციოლოგიის მიმართულებით ქვეყანაში ერთიანი, მაღალი სტანდარტის დანერგვაა. ამის მისაღწევად GSPEN-ის სახელით დაგეგმილია შემდეგი ინიციატივები:":"Our main goal is to turn European experience into Georgian reality and to establish a single, high standard of clinical nutrition across the country. To achieve this, the following initiatives are planned on behalf of GSPEN:",
"ეროვნული პროტოკოლების შემუშავება:":"Developing national protocols:",
"დავიწყებთ უახლესი საერთაშორისო გაიდლაინების სიღრმისეულ დამუშავებას და საქართველოს კლინიკურ რეალობაზე მორგებას.":"we will begin an in-depth review of the latest international guidelines and their adaptation to Georgian clinical reality.",
"მულტიდისციპლინური განათლება (ექიმები და ექთნები):":"Multidisciplinary education (physicians and nurses):",
"ვინაიდან პაციენტის ნუტრიციული მართვა გუნდურ მუშაობას მოითხოვს, განვაგრძობთ ადგილობრივი ვებინარების, პრაქტიკული ვორქშოფების და სამუშაო შეხვედრების ორგანიზებას როგორც მოქმედი ექიმებისთვის, ისე ექთნებისთვის, რომელთა როლიც უმნიშვნელოვანესია კვების პროტოკოლების უშუალო აღსრულების პროცესში.":"since a patient's nutritional management requires teamwork, we will continue organising local webinars, practical workshops and working meetings both for practising physicians and for nurses, whose role is essential in the direct implementation of nutrition protocols.",
"მომავალი თაობის განვითარება:":"Developing the next generation:",
"განსაკუთრებული ყურადღება დაეთმობა სამედიცინო ფაკულტეტის სტუდენტებთან მუშაობას. მათთვის დაიგეგმება სპეციალური საგანმანათლებლო შეხვედრები, რათა მომავალმა კოლეგებმა საუნივერსიტეტო ეტაპიდანვე გაითავისონ კლინიკური ნუტრიციოლოგიის ფუნდამენტური პრინციპები და დაინტერესდნენ ამ მნიშვნელოვანი სფეროთი.":"special attention will be devoted to working with medical students. Dedicated educational meetings will be planned for them, so that our future colleagues absorb the fundamental principles of clinical nutrition from their university years and take an interest in this important field.",
"როგორ გავხდეთ წევრი?":"How to become a member?",
"შეღავათიანი ტარიფით ESPEN-ის წევრობა ექსკლუზიურად GSPEN-ის წევრებისთვისაა ხელმისაწვდომი. ერთად ჩავუყაროთ საფუძველი კლინიკური ნუტრიციოლოგიის განვითარებას საქართველოში!":"ESPEN membership at the special rate is available exclusively to GSPEN members. Let us lay the foundation for the development of clinical nutrition in Georgia together!",
"დაინტერესების შემთხვევაში, მოგვწერეთ ელექტრონულ ფოსტაზე:":"If you are interested, write to us at:",
". ჩვენ მოგაწვდით დეტალურ ინფორმაციას გაწევრიანების ნაბიჯებსა და გადახდის წესზე.":". We will send you detailed information about the membership steps and payment arrangements.",
/* ===== nutritionDay project ===== */
"nutritionDay საქართველოში — საერთაშორისო კვლევა კლინიკურ კვებაზე":"nutritionDay in Georgia — an international study on clinical nutrition",
"GSPEN nutritionDay-ს ეროვნული კოორდინატორია საქართველოში.":"GSPEN is the national coordinator of nutritionDay in Georgia.",
"GSPEN nutritionDay-ს ეროვნული კოორდინატორია საქართველოში — შემოუერთდი მსოფლიოს ყველაზე მასშტაბურ კლინიკური კვების აუდიტს.":"GSPEN is the national coordinator of nutritionDay in Georgia — join the world's largest audit of clinical nutrition.",
"GSPEN nutritionDay-ს ეროვნული კოორდინატორია საქართველოში — შემოუერთდი მონაწილე კლინიკებს და გახდი კვლევის თანაავტორი →":"GSPEN is the national coordinator of nutritionDay in Georgia — join the participating clinics and become a co-author of the study →",
"რა არის nutritionDay":"What is nutritionDay",
"nutritionDay კლინიკური კვების მსოფლიოში ყველაზე მასშტაბური აუდიტია, რომელიც 2006 წლიდან ყოველწლიურად ტარდება. პროექტს ვენის სამედიცინო უნივერსიტეტის გუნდი კოორდინირებს და მას ESPEN უჭერს მხარს. ამ ხნის განმავლობაში კვლევას 75 ქვეყნის კლინიკები შეუერთდნენ და 300 000-ზე მეტი პაციენტის მონაცემი შეგროვდა. მიზანი მარტივია: დაავადებასთან დაკავშირებული მალნუტრიცია საავადმყოფოებში დროულად შესამჩნევი გახდეს, ნუტრიციული ზრუნვის ხარისხი კი გაიზომოს და გაუმჯობესდეს.":"nutritionDay is the world's largest audit of clinical nutrition, held annually since 2006. The project is coordinated by the team of the Medical University of Vienna and is supported by ESPEN. Over this time, clinics from 75 countries have joined the study and data on more than 300,000 patients have been collected. The aim is simple: to make disease-related malnutrition in hospitals visible in time, and to measure and improve the quality of nutritional care.",
"მონაწილე განყოფილებები სტანდარტიზებული კითხვარებით აგროვებენ მონაცემებს განყოფილების ორგანიზებაზე, პაციენტების მდგომარეობასა და კვებაზე; 30 დღის შემდეგ პაციენტის გამოსავალიც ფასდება. კვლევა არაინტერვენციულია — პაციენტის მკურნალობა არ იცვლება და მონაცემები ანონიმურია.":"Participating units use standardised questionnaires to collect data on unit organisation, patients' condition and nutrition; 30 days later the patient's outcome is also assessed. The study is non-interventional — the patient's treatment does not change and the data are anonymous.",
"რას იღებს მონაწილე კლინიკა":"What a participating clinic receives",
"მყისიერ Smart Report-ს — საკუთარი განყოფილების შედეგებს იმავე პროფილის მსოფლიო კლინიკებთან შედარებით;":"An instant Smart Report — your unit's results compared with clinics of the same profile worldwide;",
"nutritionDay-ს საერთაშორისო სერტიფიკატს;":"The international nutritionDay certificate;",
"განმეორებითი მონაწილეობისას — ხარისხის დინამიკას წლიდან წლამდე.":"With repeated participation — quality trends from year to year.",
"რას იღებს თითოეული მონაწილე":"What each participant receives",
"ყველას, ვინც პროექტში ჩაერთვება, აქვს შესაძლებლობა, შეგროვებული მონაცემების საფუძველზე სამეცნიერო პუბლიკაცია მოამზადოს — ანალიზსა და წერაში ვენის სამედიცინო უნივერსიტეტის nutritionDay-ს გუნდი ეხმარება.":"Everyone who joins the project has the opportunity to prepare a scientific publication based on the collected data — the nutritionDay team of the Medical University of Vienna helps with the analysis and the writing.",
"როგორ ჩავერთო":"How to join",
"თუ გსურთ, თქვენი კლინიკა ან განყოფილება პროექტს შეუერთდეს, მოგვწერეთ:":"If you would like your clinic or unit to join the project, write to us:",
". დამატებითი ინფორმაცია იხილეთ პროექტის ოფიციალურ საიტზე:":". Further information is available on the project's official website:",
/* ===== ESPEN block membership news ===== */
"მიიღე მონაწილეობა საერთაშორისო კვლევაში nutritionDay":"Take part in the international nutritionDay study",
"სიახლე":"News",
"სიახლე · საერთაშორისო თანამშრომლობა":"News · International partnership",
"GSPEN ESPEN-ის ბლოკწევრი გახდა":"GSPEN becomes a block member of ESPEN",
"ჩვენი წევრებისთვის — ESPEN-ის სრული წევრობა შეღავათიანი ტარიფით":"For our members — full ESPEN membership at a reduced rate",
"წაიკითხე მეტი →":"Read more →",
"GSPEN ევროპის კლინიკური კვების საზოგადოების (ESPEN) ბლოკწევრი გახდა":"GSPEN becomes a block member of the European Society for Clinical Nutrition and Metabolism (ESPEN)",
"ჩვენს წევრებს ESPEN-ის სრული წევრობა შეღავათიანი ტარიფით შეეძლებათ — გაიგე, რას ნიშნავს ეს შენთვის →":"Our members will be able to obtain full ESPEN membership at a reduced rate — find out what it means for you →",
"საქართველოს საზოგადოება ოფიციალურად შეუერთდა ESPEN-ს — ჩვენს წევრებს ევროპული საზოგადოების სრული წევრობა შეღავათიანი ტარიფით შეეძლებათ.":"The Georgian society has officially joined ESPEN — our members will be able to obtain full membership of the European society at a reduced rate.",
"მოხარულნი ვართ გაცნობოთ: საქართველოს პარენტერალური, ენტერალური კვებისა და მეტაბოლიზმის საზოგადოებამ (GSPEN) ბლოკწევრობის (Block Membership) შეთანხმებას მოაწერა ხელი ევროპის კლინიკური კვებისა და მეტაბოლიზმის საზოგადოებასთან (ESPEN — The European Society for Clinical Nutrition and Metabolism). ამიერიდან GSPEN ოფიციალურად უერთდება ევროპულ პროფესიულ ოჯახს, რომელშიც კლინიკური კვების წამყვანი ეროვნული საზოგადოებები არიან გაერთიანებულნი.":"We are delighted to announce that the Georgian Society for Parenteral, Enteral Nutrition and Metabolism (GSPEN) has signed a Block Membership agreement with the European Society for Clinical Nutrition and Metabolism (ESPEN). From now on, GSPEN officially joins the European professional family that unites the leading national societies in clinical nutrition.",
"რა არის ბლოკწევრობა":"What is block membership",
"ბლოკწევრობა ESPEN-ის სპეციალური სტატუსია იმ ეროვნული საზოგადოებებისთვის, რომლებთანაც ევროპულ საზოგადოებას პირდაპირი შეთანხმება აქვს გაფორმებული. ამ სტატუსის წყალობით GSPEN-ის თითოეულ წევრს შეუძლია, ESPEN-ის სრულუფლებიანი წევრი გახდეს შეღავათიანი ტარიფით — წელიწადში 90 ევროდ ინდივიდუალური წევრობის სტანდარტული 120 ევროს ნაცვლად — და მიიღოს ზუსტად ის სარგებელი, რასაც ინდივიდუალური წევრობა ითვალისწინებს. საწევრო ESPEN-ის საიტზე ონლაინ არ იხდება: გადახდას ეროვნული საზოგადოება — ამ შემთხვევაში GSPEN — აწესრიგებს და თანხას თავად ურიცხავს ESPEN-ს.":"Block membership is a special ESPEN status for national societies that have a direct agreement with the European society. Thanks to this status, every GSPEN member can become a full ESPEN member at a special rate — € 90 per year instead of the standard € 120 individual fee — and receive exactly the same benefits as an individual member. The fee is not paid online on the ESPEN website: payment is arranged by the national society — in this case GSPEN — which then transfers it to ESPEN.",
"რას იღებს ESPEN-ის წევრი":"What an ESPEN member receives",
"უფასო ონლაინ წვდომა ჟურნალებზე Clinical Nutrition და Clinical Nutrition ESPEN":"Free online access to the journals Clinical Nutrition and Clinical Nutrition ESPEN",
"შეღავათიანი რეგისტრაცია ESPEN-ის ყოველწლიურ კონგრესზე":"Discounted registration for the annual ESPEN Congress",
"შემცირებული ტარიფი LLL (Life Long Learning) კურსებზე და წვდომა სასწავლო პლატფორმაზე lllnutrition.com":"Reduced rates for LLL (Life Long Learning) courses and access to the lllnutrition.com learning platform",
"ESPEN-ის კვლევით, სასწავლო და სამოგზაურო გრანტებზე განაცხადის შესაძლებლობა":"Eligibility to apply for ESPEN research, educational and travel grants",
"ESPEN-ის ვებინარები, წინა კონგრესების ჩანაწერები და საზოგადოების სიახლეების ბიულეტენი":"ESPEN webinars, recordings of past congresses and the society's newsletter",
"ფასდაკლება სტატიის გამოქვეყნებაზე ღია წვდომის ჟურნალში Clinical Nutrition Open Science":"A discount on publishing in the open-access journal Clinical Nutrition Open Science",
"რას ნიშნავს ეს ჩვენთვის":"What this means for us",
"ეს ქართული კლინიკური კვების საზოგადოებისთვის მნიშვნელოვანი ნაბიჯია. ESPEN-ის წევრობა ქართველ ექიმებს, დიეტოლოგებსა და ნუტრიციის სპეციალისტებს პირდაპირ აკავშირებს ევროპულ სამეცნიერო სივრცესთან: უადვილებს წვდომას თანამედროვე გაიდლაინებზე, კვლევებსა და განათლების პროგრამებზე და საშუალებას აძლევს, საკუთარი გამოცდილება საერთაშორისო კოლეგებს გაუზიარონ. ამავე დროს, ეს GSPEN-ის, როგორც კლინიკური კვების ეროვნული წარმომადგენლობითი ორგანოს, საერთაშორისო აღიარებაა.":"This is an important step for the Georgian clinical nutrition community. ESPEN membership connects Georgian physicians, dietitians and nutrition professionals directly to the European scientific community: it eases access to up-to-date guidelines, research and educational programmes, and allows them to share their own experience with international colleagues. At the same time, it is international recognition of GSPEN as the national representative body for clinical nutrition.",
"როგორ გავხდე ESPEN-ის წევრი":"How to become an ESPEN member",
"შეღავათიანი ტარიფით ESPEN-ის წევრობა GSPEN-ის წევრებისთვისაა ხელმისაწვდომი. თუ დაინტერესებული ხართ, მოგვწერეთ:":"ESPEN membership at the special rate is available to GSPEN members. If you are interested, write to us:",
"მოგაწვდით დეტალურ ინფორმაციას გაწევრიანების ნაბიჯებსა და გადახდის წესზე.":"We will send you detailed information about the membership steps and payment arrangements."
};
