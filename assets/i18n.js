...
"ჩვენი გუნდის წევრმა ნინა ზივზივაძემ ESPEN-ის გრანტი მიიღო":"Our team member Nina Zivzivadze has received an ESPEN grant",
...
"ნინა წავა ბელგიაში, KU Leuven-ის უნივერსიტეტში, 14-დღიან პროფესიულ კურსზე — ESPEN-ის 2026 წლის საგანმანათლებლო გრანტით.":"Nina is going to Belgium, to KU Leuven University, for a 14-day professional course — with the 2026 ESPEN Educational Grant.",
"ჩვენი გუნდის წევრმა ნინა ზივზივაძემ ESPEN-ის (ევროპის კლინიკური ნუტრიციოლოგიისა და მეტაბოლიზმის საზოგადოება) 2026 წლის საგანმანათლებლო გრანტი მიიღო.":"Our team member Nina Zivzivadze has received the 2026 Educational Grant of ESPEN (the European Society for Clinical Nutrition and Metabolism).",
"ნინა წავა ბელგიაში, KU Leuven-ის უნივერსიტეტში, Prof. Christophe Matthys-ის ხელმძღვანელობით, 14-დღიან პროფესიულ კურსზე. კურსის ფარგლებში ის პრაქტიკულ გამოცდილებას მიიღებს კლინიკური კვების, მეტაბოლიზმის, ენდოკრინოლოგიისა და სიმსუქნის მართვის მიმართულებით — მათ შორის პედიატრიულ პაციენტებთან მუშაობაში.":"Nina is going to Belgium, to KU Leuven University, for a 14-day professional course under the supervision of Prof. Christophe Matthys. During the course she will gain practical experience in clinical nutrition, metabolism, endocrinology and obesity management — including work with paediatric patients.",
